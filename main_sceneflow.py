...
parser.add_argument('--model', default='srblocknum20', help='select a model structure', choices=__models__.keys())
...
parser.add_argument('--batch_size', type=int, default=38, help='training batch size')
parser.add_argument('--test_batch_size', type=int, default=38, help='testing batch size')
...
parser.add_argument('--lrepochs', type=str, default="8,11,14,17,20,23,25,27,29,30:2", help='the epochs to decay lr: the downscale rate')

parser.add_argument('--logdir',default='/root/autodl-tmp/runs/sceneflow/NeXt_Stereo/finalpass_finetune/', help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default='/root/autodl-tmp/runs/sceneflow/NeXt_Stereo/finalpass/checkpoint_000025.ckpt',help='load the weights from a specific checkpoint')
