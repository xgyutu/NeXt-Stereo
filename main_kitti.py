...
parser.add_argument('--test_batch_size', type=int, default=40, help='testing batch size')
...
parser.add_argument('--logdir', default='/root/autodl-tmp/runs/kitti/NeXt_Stereo/finalpass_finetune/', help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default='/root/autodl-tmp/runs/sceneflow/NeXt_Stereo/blocknum/srblocknum20/checkpoint_000025.ckpt', help='load the weights from a specific checkpoint')
